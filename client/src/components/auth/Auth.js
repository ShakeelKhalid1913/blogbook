             ...
             <Col md={7}>
                <Layout>
                   ...
                   <Form ref={formRef} form={form} layout={"vertical"} onFinish={handleSubmit}>
                      ...
                      {
                         type === "Signup" ?
                             <Form.Item name={"cpassword"} label={"Confirm Password"} dependencies={['password']}
                                        rules={[
                                           {
                                              required: true,
                      ...
                      <Form.Item>
                         <Space size={10}>
                            <Button name="submit" type={"primary"} htmlType={"submit"}>{type}</Button>
                            <Button type={"primary"} onClick={(e) => {
                               setType(type === 'Login' ? "Signup" : "Login")
                               formRef.current.resetFields()
                            }}>Switch
                               to {type === 'Login' ? "Signup" : "Login"}</Button>
                         </Space>
                      </Form.Item>
                   </Form>
                   {
