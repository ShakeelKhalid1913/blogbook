...
function CreateBlog (props) {
  ...
  const onFormFinish = (event) => {
    ...
    BlogService.uploadBlog(formData)
      .then((res) => {
        notification.open({
          message: 'Notification',
          description: 'Blog successfully Upload',
      ...
      <Layout>
        ...
        >
          <Form.Item
            name='title'
            label='Title'
            rules={[{ required: true, message: 'Title must required' }]}
          >
          ...
          <Form.Item
            ...
            rules={[
              ...
              () => ({
                validator (_, value) {
                  if (!value || value.length >= 10) return Promise.resolve()
          ...
          <Form.Item
            ...
            rules={[{ required: false, message: ' Please Upload Content' }]}
          >
            <Dragger
              maxCount={1}
              accept='/upload.do'
            ...
            >
              ...
              <p className='ant-upload-text'>
                Click or drag Blog Picture to this area to upload
              </p>
